...
| [Finding the best tariff for a cellular company](projects/mobile_company) |  На основе данных клиентов оператора сотовой связи проанализировать поведение клиентов и поиск оптимального тарифа. | Python, Pandas, Matplotlib, NumPy, SciPy, A/B (testing of statistical hypotheses). |
| [Identifying the patterns that determine the success of the game.](projects/games) |  Выявить определяющие успешность игры закономерности. | Python, Pandas, Matplotlib, NumPy, SciPy, A/B (testing of statistical hypotheses). |
